from UnstructuredCAEDA.settings.base_3D import Config3D
from UnstructuredCAEDA.AEs.AE_general import GenCAE
from UnstructuredCAEDA.AEs.AE_general import MODES as M
from UnstructuredCAEDA.ML_utils import ConvScheduler

from itertools import cycle, islice
from UnstructuredCAEDA.settings.helpers import recursive_len, recursive_set
from UnstructuredCAEDA.settings.helpers import recursive_set_same_struct, recursive_update
from UnstructuredCAEDA.settings.helpers import flatten_list
...
class Block(Config3D):
    ...
    which is the base configuration class """
    ...
    def gen_blocks_with_kwargs(self):
        ...
        # print("Generating the model with the kwargs BASE BLOCK with dimensions {} \n strides {} \n downsample {} \n channels {}".format(self.get_n(), strides, downsample, channels))
        conv_data = ConvScheduler.conv_scheduler3D(self.get_n(), None, 1, False, strides=strides)
        ...
        # print("Block w kwargs", blocks_w_kwargs)
