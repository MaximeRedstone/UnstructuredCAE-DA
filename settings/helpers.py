...
def set_local_dirs(settings):
    ...
    # settings.DATA_FP = "/Users/maxime/IndividualProject/data/subdomain_8/"
    # settings.INTERMEDIATE_FP = "/Users/maxime/IndividualProject/DA/8_intermediate/"
    # settings.DATA_FP = settings.HOME_DIR + "../../data/subdomain_8/"
    # settings.INTERMEDIATE_FP = settings.HOME_DIR + "../../DA/8_intermediate/"
